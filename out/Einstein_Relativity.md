...
place specification “Trafalgar Square, London,” 1 
...
v is small compared with unity, the third 
...
F we pick up a stone and then let it go, why 
 ...
 does it fall to the ground?” The usual 
...
if I have never before seen a gas flame. For I 
...
something in neither case, and if I observe that 

the one continuously emits steam whilst the 

other does not, then I shall remain astonished 
...
in classical mechanics (or in the special theory 
...
the reference\-systems K and K'.1 Newton saw 
...
HE considerations of Section XX show 
 ...
 that the general theory\* of relativity puts 

 us in a position to derive properties of the 

gravitational field in a purely theoretical manner. 

Let us suppose, for instance, that we know the 
...
\[\* The word “theory” was changed to “principle” in both places in 
...
curvilinear motion with respect to the accelerated 
...
c. It can easily be shown that the path of the 
...
incidence is nevertheless 1\.7 seconds of arc. This 
...
INFERENCES FROM RELATIVITY 89 

As seen from the earth, certain fixed stars appear 
...
is situated at another part of the heavens. The 
...
1 By means of the star photographs of two expeditions equipped 
...
i.e. domains in which gravitational fields are 
...
time.1 The character of this field will of course 
...
1 This follows from a generalisation of the discussion in Sec\-
...
can be produced in this way, yet we may enter\-
...
on Newton’s theory of gravitation.1 But since 
...
1 The field disappears at the centre of the disc and increases pro\-
...
BEHAVIOUR OF CLOCKS AND RODS 95 
...
quotient the familiar number p \= 3\.14 . . ., but 

a larger number,1 whereas of course, for a disc 
...
BEHAVIOUR OF CLOCKS AND RODS 97 

would yield p exactly. This proves that the 
...
HE surface of a marble table is spread out 
 ...
 in front of me. I can get from any one 
...
EUCLIDEAN AND NON\-EUCLIDEAN 99 
...
for rigid bodies.1 The reader will notice that 
...
magnitudes g11, g12 and g22 determine the behaviour 
...
associate arbitrarily four numbers, x1, x2, x3, x4, 
...
where the magnitudes g11, etc., have values which 

vary with the position in the continuum. Only 

when the continuum is a Euclidean one is it 

possible to associate the co\-ordinates x1 . . x4 with 
...
Section XVII. In accordance with the special 
...
these magnitudes always fulfil the condition.1 
...
ence. We call the magnitude ds the “distance” 
...
continuum (event) four numbers, x1, x2, x3, x4 
...
must regard x1, x2, x3, as “space” co\-ordinates 

and x4 as a “time” co\-ordinate. 

 

SPACE–TIME CONTINUUM 113 
...
co\-ordinates x1, x2, x3, x4, if in themselves these 
...
time by a single system of values x1, x2, x3, x4\. 
...
co\-ordinate values, x1, x2, x3, x4, in common. 
...
stitute the only actual evidence of a time\-space 
...
co\-ordinates x1, x2, x3, x4\. Thus in reality, the 
...
cannot be maintained, because the use of rigid 
...
x, y, z, t, of a (Galileian) reference\-body K by the 
...
arbitrary substitutions of the Gauss variables x1, 

x2, x3, x4, the equations must pass over into 
...
GENERAL PRINCIPLE OF RELATIVITY 117 
...
“mollusk” a certain comprehensibleness as com\-
...
the laws themselves must be quite 
...
F the reader has followed all our previous 
 ...
 considerations, he will have no further diffi\-
...
behaviour of measuring\-rods, clocks and material 
...
thus according to Section XV only its 

energy is of importance for its effect in 

exciting a field. 

(c) Gravitational field and matter 
...
mits us to determine the influence of the gravita\-
...
SOLUTION OF GRAVITATION 123 

attainable at the present time. The sole ex\-
...
which admit of being tested by observation, to wit, 

the curvature of light rays by the gravitational 

field of the sun,1 and a displacement of the spectral 
...
by the same kind of molecule \*). I do not doubt 
...
editions. Cf. Appendix III, pg. 157\. — J.M.] 
...
PART from the difficulty discussed in Sec\-
 ...
 tion XXI, there is a second fundamental 
...
ought to be a finite island in the infinite ocean of 

space.1 

This conception is in itself not very satisfactory. 

It is still less satisfactory because it leads to the 
...
m is proportional to the mass m. If, on the average, the mass\-den\-

sity 

 is constant throughout the universe, then a sphere of volume 

V will enclose the average mass 

.

 Thus the number of lines of 

force passing through the surface F of the sphere into its interior is 

proportional to 

 For unit area of the surface of the sphere the 
...
UNIVERSE — FINITE YET UNBOUNDED 129 

sidered in Section XXIV. In contrast to ours, 
...
of the plane, equal to a constant value p , which is 
...
i.e. a smaller value than p , the difference being 
...
UNIVERSE — FINITE YET UNBOUNDED 131 
...
UNIVERSE — FINITE YET UNBOUNDED 133 

of r, F increases from zero up to a maximum value 
...
in the manner of the spherical universe. Our ex\-
...
THE STRUCTURE OF SPACE 137 

necessarily finite. In fact, the theory supplies 

us with a simple connection 1 between the space\- 
...
OR the relative orientation of the co\-ordi\-
 ...
 nate systems indicated in Fig. 2, the 
...
and b in place of the constants l and m where 
...
THE LORENTZ TRANSFORMATION 141 
...
by the distance D x' \= 1‡ when measured in the 
...
shots must be identical; hence D x in (7\) must 

be equal to D x' in (7a), so that we obtain 
...
x\-axis, we thus have s \= 1\. It is easily seen 

that the Lorentz transformation really satisfies 

equation (11\) for s \= 1; for (11\) is a consequence 
...
homogeneous functions of x, y, z, t, of such a kind 
...
is satisfied identically. That is to say: If we 

substitute their expressions in x, y, z, t, in place of 

x', y', z', t', on the left\-hand side, then the left\- 

hand side of (11a) agrees with the right\-hand side. 
...
of t, as time\-variable. If, in accordance with 
...
ordinate x4 enters into the condition of trans\-

formation in exactly the same way as the space 

co\-ordinates x1, x2, x3\. It is due to this fact that, 
...
x4 enters into natural laws in the same form as 

the space co\-ordinates x1, x2, x3\. 

A four\-dimensional continuum described by the 

“co\-ordinates” x1, x2, x3, x4, was called “world” 
...
system (x'1, x'2, x'3\) with the same origin, then 

x'1, x'2, x'3, are linear homogeneous functions of 

x1, x2, x3, which identically satisfy the equation 
...
ROM a systematic theoretical point of 
 ...
 view, we may imagine the process of 
...
EXPERIMENTAL CONFIRMATION 149 

general, is built up logically from a small number 
...
to the angle 2 p in the absolute angular measure 
...
e its eccentricity, c the velocity of light, and T 
...
sense as the orbital motion of the planet. Theory 
...
passes the sun at a distance of D
...
It may be added that, according to the theory, 
...
mental test by means of the 

photographic registration of stars 
...
In Section XXIII it has been shown that in a 
...
v \= w r, 
 ...
 represents the \* velocity of rotation of the 

where w

disc K' with respect to K. If n 0 represents the 

number of ticks of the clock per unit time (“rate” 

of the clock) relative to K when the clock is at 

rest, then the “rate” of the clock (n ) when it is 
...
and the centre of the disc by f , i.e. the work, 
...
gravitational field of potential f , hence the result 
...
The Foundations of Einstein’s Theory of Gravitation: Erwin Freund\-

lich (translation by H. L. Brose). Camb. Univ. Press, 1920\. 

Space and Time in Contemporary Physics: Moritz Schlick (trans\-

lation by H. L. Brose). Clarendon Press, Oxford, 1920\. 
...
W. de Sitter, M. N. Roy. Astron. Soc., lxxvi. p. 699, 1916; lxxvii. 

p. 155, 1916; lxxviii. p. 3, 1917\. 

On Einstein’s Theory of Gravitation: H. A. Lorentz, Proc. Amsterdam 

Acad., vol. xix. p. 1341, 1917\. 

Space, Time and Gravitation: W. de Sitter: The Observatory, No. 505, 

p. 412\. Taylor \& Francis, Fleet Street, London. 
...
The Displacement of Spectrum Lines and the Equivalence Hypothesis: 

W. G. Duffield, M. N. Roy. Astron. Soc., vol. lxxx.; No. 3, p. 262, 
...
— transformation, 40, 43, 45, 

50, 61 

Galileian system of co\-ordi\-

nates, 13, 15, 17, 54, 93, 

108, 116, 119 

Gauss, 102, 103, 106 

Gaussian co\-ordinates, 103–
...
Lorentz, H. A., 24, 48, 52, 58, 

59–63 

— transformation, 39, 46, 50, 
...
Principle of relativity, 15–17, 

23, 24, 70 

Processes of Nature, 50 

Propagation of light, 21, 23, 
...
Straight line, 1–3, 9, 10, 97, 

105, 129 

System of co\-ordinates, 5, 10, 
